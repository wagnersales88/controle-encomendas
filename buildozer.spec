# This .spec config file tells Buildozer an app's requirements for being builx# It largely follows the syntax of an .ini file.
# See the end of the file for more details and warnings about common mistakes.

[app]

title = Controle de Encomendas# (str) Title of your applicatioApp
# (str) Package name
...
#       [app]
#       title = MyApplication # This is not a comment, it is part of the title.
#
